...
/***/ function(module, exports, __webpack_require__) {
	...
	var choreEvents = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var choreApi = __webpack_require__(28);
	var choreUi = __webpack_require__(29);
	...
	var getChoresOnSignIn = function getChoresOnSignIn() {
	  $('#chores-table').html(template());
	  $('#create-chore').removeClass('hide');
	  choreApi.getChores().done(function (data) {
	    $('#chores-table').html('');
	    $('#chores-table').html(template(data));
	    $('.delete-chore').click(choreUi.deleteChore);
	    $('.update-chore').on('click', function (event) {
	      event.preventDefault();
	      var chore_id = $(event.target).data('id');
	...
	module.exports = {
	  ...
	  getChoresOnSignIn: getChoresOnSignIn
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <tr>\n        <th scope=\"row\"></th>\n        <td>"
	    ...
	    + "</td>\n        <td>"
	    + alias4(((helper = (helper = helpers.where || (depth0 != null ? depth0.where : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"where","hash":{},"data":data}) : helper)))
	    + "</td>\n        <td>"
	    ...
	    + "</td>\n        <td><button class=\"btn btn-default update-chore\" type=\"submit\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Update Chore</button></td>\n        <td><button class=\"btn btn-default delete-chore\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete Chore</button></td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = 
	  "<table class=\"table table-striped\">\n  <thead>\n    <tr>\n      <th></th>\n      <th>Title</th>\n      <th>Where</th>\n      <th>When</th>\n      <th>Update</th>\n      <th>Delete</th>\n    </tr>\n  </thead>\n  <tbody>\n";
	  stack1 = ((helper = (helper = helpers.chores || (depth0 != null ? depth0.chores : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"chores","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.chores) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteChore = function deleteChore(chore_id) {
	  return $.ajax({
	...
	var updateChore = function updateChore(data, chore_id) {
	  return $.ajax({
	    url: app.host + '/chores/' + chore_id,
	    method: "PATCH",
	    headers: {
	...
	var getChores = function getChores() {
	  return $.ajax({
	    url: app.host + '/chores',
	    method: "GET",
	    headers: {
	...
	var getChore = function getChore(chore_id) {
	  return $.ajax({
	    url: app.host + '/chores/' + chore_id,
	    method: "GET",
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getChores = function getChores() {
	  api.getChores().done(displayChores).fail(failure);
	};

	var deleteChore = function deleteChore(event) {
	  event.preventDefault();
	  var chore_id = $(event.target).attr('data-id');
	  api.deleteChore(chore_id).done(getChores).fail(failure);
	};

	var updateChore = function updateChore(data, chore_id) {
	  api.updateChore(data, chore_id).done(getChores).fail();
	};
	...
	var createChoreSuccess = function createChoreSuccess() {
	  $('#chores-table').html('');
	  api.getChores().done(displayChores).fail(failure);
	};

	module.exports = {
	  displayChores: displayChores,
	  getChores: getChores,
	  failure: failure,
	  deleteChore: deleteChore,
